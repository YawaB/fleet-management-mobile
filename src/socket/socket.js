...
import {
  EXPO_PUBLIC_REACT_APP_SOCKET_ROOT,
  EXPO_PUBLIC_REACT_APP_SOCKET_URL,
} from "@env";

let params = {};
if (EXPO_PUBLIC_REACT_APP_SOCKET_URL) {
  params.path = EXPO_PUBLIC_REACT_APP_SOCKET_ROOT;
} //process.env.REACT_APP_SOCKET_URL || process.env.REACT_APP_API_URL
export const socket = io(EXPO_PUBLIC_REACT_APP_SOCKET_URL, params);
